...
function likes_init() {
    ...
    $root = str_replace("likeKpax", "kpax", $root);


    elgg_register_library('elgg:kpaxSrv', "$root/lib/kpaxSrv.php");
    elgg_load_library('elgg:kpaxSrv');

    $actions_base = elgg_get_plugins_path() . 'likeKpax/actions/likes';
    
    elgg_register_action('likeKpax/add', "$actions_base/add.php");
    elgg_register_action('likeKpax/delete', "$actions_base/delete.php");
}
